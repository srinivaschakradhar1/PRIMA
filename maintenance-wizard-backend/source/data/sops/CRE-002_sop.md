# Maintenance SOP: Reciprocating Pump (Critical) (CRE-002)

**Document No:** SOP-CRE-002-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Reciprocating Pump (Critical) (CRE-002) to ensure reliable operation and to support
...
and breakdown maintenance of Reciprocating Pump (Critical) units within the Critical Rotating Equipment.
...
- [ ] Verify discharge_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify stroke_rate_spm is within normal operating range as per equipment manual.
- [ ] Verify motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify crankcase_temperature_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating valve wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating packing leakage.
...
### 3. Crankshaft bearing wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating crankshaft bearing wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating plunger wear.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-002) for stock levels,
