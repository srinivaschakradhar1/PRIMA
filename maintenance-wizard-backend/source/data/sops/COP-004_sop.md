# Maintenance SOP: Coke Transfer Car (COP-004)

**Document No:** SOP-COP-004-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Coke Transfer Car (COP-004) to ensure reliable operation and to support
...
and breakdown maintenance of Coke Transfer Car units within the Coke Oven Plant.
...
- [ ] Verify car_position_m is within normal operating range as per equipment manual.
- [ ] Verify motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify brake_temp_C is within normal operating range as per equipment manual.
- [ ] Verify wheel_vibration_mm_s is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-004-01.
...
Refer to spare parts master record (part IDs prefixed SP-COP-004) for stock levels,
