# Maintenance SOP: Gas Cleaning Plant (BF) (BF-008)

**Document No:** SOP-BF-008-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Gas Cleaning Plant (BF) (BF-008) to ensure reliable operation and to support
...
and breakdown maintenance of Gas Cleaning Plant (BF) units within the Blast Furnace.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-008-01.
...
### 2. Water spray nozzle blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating water spray nozzle blockage.
...
Refer to spare parts master record (part IDs prefixed SP-BF-008) for stock levels,
