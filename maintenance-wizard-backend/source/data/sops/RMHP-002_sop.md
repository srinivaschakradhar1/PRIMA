# Maintenance SOP: Stacker Reclaimer (RMHP-002)

**Document No:** SOP-RMHP-002-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Stacker Reclaimer (RMHP-002) to ensure reliable operation and to support
...
and breakdown maintenance of Stacker Reclaimer units within the Raw Material Handling Plant.
...
- [ ] Verify boom_slew_torque_Nm is within normal operating range as per equipment manual.
- [ ] Verify luffing_angle_deg is within normal operating range as per equipment manual.
- [ ] Verify bucket_wheel_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify motor_temp_C is within normal operating range as per equipment manual.
...
### 1. Bucket wheel bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating bucket wheel bearing failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating slew gearbox wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating belt misalignment.
...
### 4. Luffing hydraulic leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating luffing hydraulic leak.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-002) for stock levels,
