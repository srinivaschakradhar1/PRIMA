# Maintenance SOP: Mold Oscillation System (CCM-003)

**Document No:** SOP-CCM-003-01
**Category:** Continuous Casting Machine
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CCM-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Mold Oscillation System (CCM-003) to ensure reliable operation and to support
...
and breakdown maintenance of Mold Oscillation System units within the Continuous Casting Machine.
...
- [ ] Verify oscillation_frequency_Hz is within normal operating range as per equipment manual.
- [ ] Verify stroke_length_mm is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify mold_temperature_C is within normal operating range as per equipment manual.
...
### 1. Oscillation bearing wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating oscillation bearing wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CCM-003-01.
...
### 3. Mold copper plate wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mold copper plate wear.
...
### 4. Drive eccentric wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive eccentric wear.
...
Refer to spare parts master record (part IDs prefixed SP-CCM-003) for stock levels,
