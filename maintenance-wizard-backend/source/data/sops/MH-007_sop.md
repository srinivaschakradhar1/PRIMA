# Maintenance SOP: Excavator (MH-007)

**Document No:** SOP-MH-007-01
**Category:** Material Handling Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-MH-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Excavator (MH-007) to ensure reliable operation and to support
...
and breakdown maintenance of Excavator units within the Material Handling Equipment.
...
- [ ] Verify fuel_consumption_l_h is within normal operating range as per equipment manual.
- [ ] Verify track_tension_pct is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-MH-007-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating track chain wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating engine fault.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating boom pin wear.
...
Refer to spare parts master record (part IDs prefixed SP-MH-007) for stock levels,
