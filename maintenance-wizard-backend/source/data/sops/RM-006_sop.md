# Maintenance SOP: Plate Rolling Stand (RM-006)

**Document No:** SOP-RM-006-01
**Category:** Rolling Mills - Plate Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Plate Rolling Stand (RM-006) to ensure reliable operation and to support
...
and breakdown maintenance of Plate Rolling Stand units within the Rolling Mills - Plate Mill.
...
- [ ] Verify roll_gap_mm is within normal operating range as per equipment manual.
...
### 1. Roll bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll bearing failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-006-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll surface wear.
...
### 3. Screw-down mechanism wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating screw-down mechanism wear.
...
### 4. Hydraulic AGC fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic agc fault.
...
Refer to spare parts master record (part IDs prefixed SP-RM-006) for stock levels,
