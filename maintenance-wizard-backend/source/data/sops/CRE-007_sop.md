# Maintenance SOP: Motor (Critical) (CRE-007)

**Document No:** SOP-CRE-007-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Motor (Critical) (CRE-007) to ensure reliable operation and to support
...
and breakdown maintenance of Motor (Critical) units within the Critical Rotating Equipment.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-007-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rotor bar fault.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-007) for stock levels,
