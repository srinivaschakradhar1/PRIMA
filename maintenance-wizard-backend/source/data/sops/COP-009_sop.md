# Maintenance SOP: Exhauster/Blower (Coke Oven) (COP-009)

**Document No:** SOP-COP-009-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Exhauster/Blower (Coke Oven) (COP-009) to ensure reliable operation and to support
...
and breakdown maintenance of Exhauster/Blower (Coke Oven) units within the Coke Oven Plant.
...
- [ ] Verify blower_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify suction_pressure_mbar is within normal operating range as per equipment manual.
...
### 1. Impeller fouling/imbalance

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating impeller fouling/imbalance.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-009-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating seal degradation.
...
### 4. Motor winding insulation failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating motor winding insulation failure.
...
Refer to spare parts master record (part IDs prefixed SP-COP-009) for stock levels,
