# Maintenance SOP: Electric Arc Furnace (EAF-001)

**Document No:** SOP-EAF-001-01
**Category:** Electric Arc Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-EAF-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Electric Arc Furnace (EAF-001) to ensure reliable operation and to support
...
and breakdown maintenance of Electric Arc Furnace units within the Electric Arc Furnace.
...
- [ ] Verify electrode_current_A is within normal operating range as per equipment manual.
- [ ] Verify power_factor is within normal operating range as per equipment manual.
- [ ] Verify off_gas_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify lining_wear_mm is within normal operating range as per equipment manual.
...
### 1. Refractory lining wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory lining wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-EAF-001-01.
...
### 2. Water-cooled panel leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating water-cooled panel leak.
...
### 3. Electrical arcing fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating electrical arcing fault.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hearth erosion.
...
Refer to spare parts master record (part IDs prefixed SP-EAF-001) for stock levels,
