# Maintenance SOP: Cooling Tower (Power Plant) (UTL-004)

**Document No:** SOP-UTL-004-01
**Category:** Utility - Power Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling Tower (Power Plant) (UTL-004) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling Tower (Power Plant) units within the Utility - Power Plant.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-004-01.
...
### 4. Drift eliminator damage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drift eliminator damage.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-004) for stock levels,
