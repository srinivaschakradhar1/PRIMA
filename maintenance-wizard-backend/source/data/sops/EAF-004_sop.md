# Maintenance SOP: Furnace Roof Mechanism (EAF-004)

**Document No:** SOP-EAF-004-01
**Category:** Electric Arc Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-EAF-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Furnace Roof Mechanism (EAF-004) to ensure reliable operation and to support
...
and breakdown maintenance of Furnace Roof Mechanism units within the Electric Arc Furnace.
...
- [ ] Verify roof_lift_position_mm is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify rotation_angle_deg is within normal operating range as per equipment manual.
- [ ] Verify motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify seal_temperature_C is within normal operating range as per equipment manual.
...
### 1. Hydraulic cylinder wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic cylinder wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-EAF-004-01.
...
### 2. Roof refractory cracking

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roof refractory cracking.
...
### 3. Rotation gear wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rotation gear wear.
...
### 4. Water-cooled seal leakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating water-cooled seal leakage.
...
Refer to spare parts master record (part IDs prefixed SP-EAF-004) for stock levels,
