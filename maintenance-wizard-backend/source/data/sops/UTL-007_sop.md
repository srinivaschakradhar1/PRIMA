# Maintenance SOP: Compressor (ASU) (UTL-007)

**Document No:** SOP-UTL-007-01
**Category:** Utility - Air Separation Unit
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Compressor (ASU) (UTL-007) to ensure reliable operation and to support
...
and breakdown maintenance of Compressor (ASU) units within the Utility - Air Separation Unit.
...
### 1. Valve plate fracture

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating valve plate fracture.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-007-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cooling system fault.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-007) for stock levels,
