# Maintenance SOP: Tension Leveler (FL-007)

**Document No:** SOP-FL-007-01
**Category:** Finishing Lines
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-FL-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Tension Leveler (FL-007) to ensure reliable operation and to support
...
and breakdown maintenance of Tension Leveler units within the Finishing Lines.
...
- [ ] Verify strip_tension_kN is within normal operating range as per equipment manual.
- [ ] Verify flatness_deviation_mm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-FL-007-01.
...
Refer to spare parts master record (part IDs prefixed SP-FL-007) for stock levels,
