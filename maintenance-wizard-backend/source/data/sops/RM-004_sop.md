# Maintenance SOP: Run-out Table (RM-004)

**Document No:** SOP-RM-004-01
**Category:** Rolling Mills - Hot Strip Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Run-out Table (RM-004) to ensure reliable operation and to support
...
and breakdown maintenance of Run-out Table units within the Rolling Mills - Hot Strip Mill.
...
- [ ] Verify roller_speed_m_min is within normal operating range as per equipment manual.
- [ ] Verify water_spray_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify strip_temperature_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roller bearing wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive motor fault.
...
Refer to spare parts master record (part IDs prefixed SP-RM-004) for stock levels,
