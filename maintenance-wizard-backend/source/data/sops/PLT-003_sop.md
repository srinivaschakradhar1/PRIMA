# Maintenance SOP: Dryer (Pellet) (PLT-003)

**Document No:** SOP-PLT-003-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Dryer (Pellet) (PLT-003) to ensure reliable operation and to support
...
and breakdown maintenance of Dryer (Pellet) units within the Pellet Plant.
...
- [ ] Verify dryer_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify drum_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify exhaust_humidity_pct is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-003-01.
...
### 2. Drive gear failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive gear failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating burner fault.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-003) for stock levels,
