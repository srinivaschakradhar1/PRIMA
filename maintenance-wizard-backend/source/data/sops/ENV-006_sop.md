# Maintenance SOP: Gas Cleaning Plant (ENV) (ENV-006)

**Document No:** SOP-ENV-006-01
**Category:** Environmental Control Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-ENV-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Gas Cleaning Plant (ENV) (ENV-006) to ensure reliable operation and to support
...
and breakdown maintenance of Gas Cleaning Plant (ENV) units within the Environmental Control Systems.
...
- [ ] Verify differential_pressure_mbar is within normal operating range as per equipment manual.
- [ ] Verify gas_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify scrubber_water_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify dust_concentration_mgm3 is within normal operating range as per equipment manual.
- [ ] Verify outlet_pressure_bar is within normal operating range as per equipment manual.
...
### 1. Venturi scrubber erosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating venturi scrubber erosion.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-ENV-006-01.
...
### 2. Spray nozzle blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating spray nozzle blockage.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating demister clogging.
...
### 4. Pressure control valve fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pressure control valve fault.
...
Refer to spare parts master record (part IDs prefixed SP-ENV-006) for stock levels,
