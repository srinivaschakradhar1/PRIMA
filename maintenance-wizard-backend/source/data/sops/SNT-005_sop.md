# Maintenance SOP: Cooling System (Sinter) (SNT-005)

**Document No:** SOP-SNT-005-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling System (Sinter) (SNT-005) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling System (Sinter) units within the Sinter Plant.
...
- [ ] Verify sinter_outlet_temp_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan blade wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-005-01.
...
### 2. Grate plate warping

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating grate plate warping.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-005) for stock levels,
