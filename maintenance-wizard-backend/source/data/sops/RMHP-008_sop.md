# Maintenance SOP: Dust Extraction System (RMHP-008)

**Document No:** SOP-RMHP-008-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Dust Extraction System (RMHP-008) to ensure reliable operation and to support
...
and breakdown maintenance of Dust Extraction System units within the Raw Material Handling Plant.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-008-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan blade imbalance.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating motor bearing failure.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-008) for stock levels,
