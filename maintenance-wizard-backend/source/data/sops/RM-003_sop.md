# Maintenance SOP: Finishing Mill (RM-003)

**Document No:** SOP-RM-003-01
**Category:** Rolling Mills - Hot Strip Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Finishing Mill (RM-003) to ensure reliable operation and to support
...
and breakdown maintenance of Finishing Mill units within the Rolling Mills - Hot Strip Mill.
...
- [ ] Verify roll_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify rolling_force_kN is within normal operating range as per equipment manual.
- [ ] Verify strip_thickness_mm is within normal operating range as per equipment manual.
...
### 1. Roll wear/spalling

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll wear/spalling.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-003-01.
...
### 3. Thickness control fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating thickness control fault.
...
### 4. Hydraulic actuator leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic actuator leak.
...
Refer to spare parts master record (part IDs prefixed SP-RM-003) for stock levels,
