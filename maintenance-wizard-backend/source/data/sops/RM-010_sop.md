# Maintenance SOP: Looper (Bar & Rod Mill) (RM-010)

**Document No:** SOP-RM-010-01
**Category:** Rolling Mills - Bar & Rod Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-010-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Looper (Bar & Rod Mill) (RM-010) to ensure reliable operation and to support
...
and breakdown maintenance of Looper (Bar & Rod Mill) units within the Rolling Mills - Bar & Rod Mill.
...
- [ ] Verify looper_angle_deg is within normal operating range as per equipment manual.
- [ ] Verify tension_control_pct is within normal operating range as per equipment manual.
- [ ] Verify motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify pneumatic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify response_time_ms is within normal operating range as per equipment manual.
...
### 1. Pneumatic cylinder leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pneumatic cylinder leak.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-010-01.
...
### 2. Position sensor drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating position sensor drift.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating looper arm wear.
...
### 4. Tension control fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tension control fault.
...
Refer to spare parts master record (part IDs prefixed SP-RM-010) for stock levels,
