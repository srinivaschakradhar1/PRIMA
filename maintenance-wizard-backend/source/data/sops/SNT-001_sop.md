# Maintenance SOP: Mixing Drum (SNT-001)

**Document No:** SOP-SNT-001-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Mixing Drum (SNT-001) to ensure reliable operation and to support
...
and breakdown maintenance of Mixing Drum units within the Sinter Plant.
...
- [ ] Verify drum_speed_rpm is within normal operating range as per equipment manual.
...
- [ ] Verify moisture_content_pct is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drum lining wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-001-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive gear wear.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-001) for stock levels,
