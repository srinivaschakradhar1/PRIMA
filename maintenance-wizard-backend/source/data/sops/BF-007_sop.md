# Maintenance SOP: Taphole Drilling Machine (BF-007)

**Document No:** SOP-BF-007-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Taphole Drilling Machine (BF-007) to ensure reliable operation and to support
...
and breakdown maintenance of Taphole Drilling Machine units within the Blast Furnace.
...
- [ ] Verify drill_rpm is within normal operating range as per equipment manual.
- [ ] Verify feed_force_kN is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify drill_bit_temp_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drill bit wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-007-01.
...
### 2. Hydraulic seal leakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic seal leakage.
...
### 3. Feed mechanism jam

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating feed mechanism jam.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating motor overload.
...
Refer to spare parts master record (part IDs prefixed SP-BF-007) for stock levels,
