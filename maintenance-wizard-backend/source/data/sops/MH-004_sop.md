# Maintenance SOP: Ladle Crane (MH-004)

**Document No:** SOP-MH-004-01
**Category:** Material Handling Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-MH-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Ladle Crane (MH-004) to ensure reliable operation and to support
...
and breakdown maintenance of Ladle Crane units within the Material Handling Equipment.
...
- [ ] Verify hoist_load_t is within normal operating range as per equipment manual.
- [ ] Verify hoist_motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify wire_rope_tension_kN is within normal operating range as per equipment manual.
- [ ] Verify brake_temperature_C is within normal operating range as per equipment manual.
...
### 1. Wire rope thermal degradation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating wire rope thermal degradation.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-MH-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating brake lining wear.
...
### 3. Hoist gearbox failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hoist gearbox failure.
...
### 4. Hook wear/deformation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hook wear/deformation.
...
Refer to spare parts master record (part IDs prefixed SP-MH-004) for stock levels,
