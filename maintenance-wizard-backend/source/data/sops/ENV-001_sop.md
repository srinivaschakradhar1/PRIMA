# Maintenance SOP: Bag Filter (ENV-001)

**Document No:** SOP-ENV-001-01
**Category:** Environmental Control Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-ENV-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Bag Filter (ENV-001) to ensure reliable operation and to support
...
and breakdown maintenance of Bag Filter units within the Environmental Control Systems.
...
- [ ] Verify outlet_dust_concentration_mgm3 is within normal operating range as per equipment manual.
- [ ] Verify pulse_valve_cycle_count is within normal operating range as per equipment manual.
- [ ] Verify bag_temperature_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating bag tearing.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-ENV-001-01.
...
### 2. Pulse jet valve failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pulse jet valve failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cage corrosion.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hopper bridging.
...
Refer to spare parts master record (part IDs prefixed SP-ENV-001) for stock levels,
