# Maintenance SOP: Fume Extraction System (BOF) (BOF-006)

**Document No:** SOP-BOF-006-01
**Category:** Basic Oxygen Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BOF-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Fume Extraction System (BOF) (BOF-006) to ensure reliable operation and to support
...
and breakdown maintenance of Fume Extraction System (BOF) units within the Basic Oxygen Furnace.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan blade erosion.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BOF-006-01.
...
### 2. Damper actuator failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating damper actuator failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hood seal leakage.
...
Refer to spare parts master record (part IDs prefixed SP-BOF-006) for stock levels,
