# Maintenance SOP: Slag Granulation Unit (BF-010)

**Document No:** SOP-BF-010-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-010-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Slag Granulation Unit (BF-010) to ensure reliable operation and to support
...
and breakdown maintenance of Slag Granulation Unit units within the Blast Furnace.
...
- [ ] Verify slag_flow_rate_t_h is within normal operating range as per equipment manual.
- [ ] Verify granulation_drum_speed_rpm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating nozzle erosion.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-010-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drum bearing wear.
...
### 4. Slag runner blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating slag runner blockage.
...
Refer to spare parts master record (part IDs prefixed SP-BF-010) for stock levels,
