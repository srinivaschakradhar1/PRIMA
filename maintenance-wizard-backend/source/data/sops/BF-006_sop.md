# Maintenance SOP: Mud Gun (BF-006)

**Document No:** SOP-BF-006-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Mud Gun (BF-006) to ensure reliable operation and to support
...
and breakdown maintenance of Mud Gun units within the Blast Furnace.
...
- [ ] Verify clay_feed_rate_kg_min is within normal operating range as per equipment manual.
- [ ] Verify piston_position_mm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating piston seal wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-006-01.
...
### 2. Hydraulic pump degradation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic pump degradation.
...
### 4. Mud gun barrel wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mud gun barrel wear.
...
Refer to spare parts master record (part IDs prefixed SP-BF-006) for stock levels,
