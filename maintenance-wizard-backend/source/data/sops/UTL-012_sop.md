# Maintenance SOP: Air Compressor (Compressed Air) (UTL-012)

**Document No:** SOP-UTL-012-01
**Category:** Utility - Compressed Air Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-012-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Air Compressor (Compressed Air) (UTL-012) to ensure reliable operation and to support
...
and breakdown maintenance of Air Compressor (Compressed Air) units within the Utility - Compressed Air Systems.
...
- [ ] Verify discharge_temperature_C is within normal operating range as per equipment manual.
...
- [ ] Verify oil_level_pct is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-012-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating piston ring wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating air leak in system.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-012) for stock levels,
