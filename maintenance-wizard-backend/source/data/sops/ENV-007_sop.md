# Maintenance SOP: Continuous Emission Monitoring System (CEMS) (ENV-007)

**Document No:** SOP-ENV-007-01
**Category:** Environmental Control Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-ENV-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Continuous Emission Monitoring System (CEMS) (ENV-007) to ensure reliable operation and to support
...
and breakdown maintenance of Continuous Emission Monitoring System (CEMS) units within the Environmental Control Systems.
...
- [ ] Verify SO2_concentration_ppm is within normal operating range as per equipment manual.
- [ ] Verify NOx_concentration_ppm is within normal operating range as per equipment manual.
- [ ] Verify CO_concentration_ppm is within normal operating range as per equipment manual.
- [ ] Verify particulate_mgm3 is within normal operating range as per equipment manual.
- [ ] Verify sample_flow_rate_l_min is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating analyzer drift.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-ENV-007-01.
...
### 2. Sample probe clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating sample probe clogging.
...
### 3. Calibration gas depletion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating calibration gas depletion.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating heated line fault.
...
Refer to spare parts master record (part IDs prefixed SP-ENV-007) for stock levels,
