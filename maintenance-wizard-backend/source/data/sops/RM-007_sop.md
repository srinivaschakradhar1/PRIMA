# Maintenance SOP: Leveler (Plate Mill) (RM-007)

**Document No:** SOP-RM-007-01
**Category:** Rolling Mills - Plate Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Leveler (Plate Mill) (RM-007) to ensure reliable operation and to support
...
and breakdown maintenance of Leveler (Plate Mill) units within the Rolling Mills - Plate Mill.
...
- [ ] Verify roll_force_kN is within normal operating range as per equipment manual.
- [ ] Verify roll_gap_mm is within normal operating range as per equipment manual.
- [ ] Verify plate_flatness_dev_mm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating leveler roll wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-007-01.
...
Refer to spare parts master record (part IDs prefixed SP-RM-007) for stock levels,
