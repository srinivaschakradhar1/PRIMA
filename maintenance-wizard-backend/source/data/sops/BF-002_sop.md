# Maintenance SOP: Bell-less Top Charging System (BF-002)

**Document No:** SOP-BF-002-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Bell-less Top Charging System (BF-002) to ensure reliable operation and to support
...
and breakdown maintenance of Bell-less Top Charging System units within the Blast Furnace.
...
- [ ] Verify chute_rotation_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify hopper_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify material_flow_rate_t_h is within normal operating range as per equipment manual.
- [ ] Verify gear_temperature_C is within normal operating range as per equipment manual.
...
### 1. Rotating chute wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rotating chute wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-002-01.
...
### 2. Seal valve leakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating seal valve leakage.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hopper gate jam.
...
### 4. Drive gearbox wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive gearbox wear.
...
Refer to spare parts master record (part IDs prefixed SP-BF-002) for stock levels,
