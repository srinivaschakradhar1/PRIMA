# Maintenance SOP: Skin Pass Mill (FL-006)

**Document No:** SOP-FL-006-01
**Category:** Finishing Lines
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-FL-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Skin Pass Mill (FL-006) to ensure reliable operation and to support
...
and breakdown maintenance of Skin Pass Mill units within the Finishing Lines.
...
- [ ] Verify surface_roughness_Ra is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-FL-006-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll chock wear.
...
Refer to spare parts master record (part IDs prefixed SP-FL-006) for stock levels,
