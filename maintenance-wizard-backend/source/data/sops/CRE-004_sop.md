# Maintenance SOP: Fan (Critical) (CRE-004)

**Document No:** SOP-CRE-004-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Fan (Critical) (CRE-004) to ensure reliable operation and to support
...
and breakdown maintenance of Fan (Critical) units within the Critical Rotating Equipment.
...
- [ ] Verify airflow_m3_h is within normal operating range as per equipment manual.
...
### 1. Blade erosion/imbalance

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating blade erosion/imbalance.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating belt slip.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating motor overheating.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-004) for stock levels,
