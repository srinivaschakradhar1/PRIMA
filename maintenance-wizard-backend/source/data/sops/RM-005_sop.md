# Maintenance SOP: Coiler (RM-005)

**Document No:** SOP-RM-005-01
**Category:** Rolling Mills - Hot Strip Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Coiler (RM-005) to ensure reliable operation and to support
...
and breakdown maintenance of Coiler units within the Rolling Mills - Hot Strip Mill.
...
- [ ] Verify mandrel_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify wrapper_roll_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify coil_tension_kN is within normal operating range as per equipment manual.
...
### 1. Mandrel segment wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mandrel segment wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-005-01.
...
### 2. Wrapper roll actuator fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating wrapper roll actuator fault.
...
### 4. Coil ejection mechanism jam

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating coil ejection mechanism jam.
...
Refer to spare parts master record (part IDs prefixed SP-RM-005) for stock levels,
