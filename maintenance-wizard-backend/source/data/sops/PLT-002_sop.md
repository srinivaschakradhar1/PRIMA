# Maintenance SOP: Pellet Induration Furnace (PLT-002)

**Document No:** SOP-PLT-002-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Pellet Induration Furnace (PLT-002) to ensure reliable operation and to support
...
and breakdown maintenance of Pellet Induration Furnace units within the Pellet Plant.
...
- [ ] Verify grate_speed_m_min is within normal operating range as per equipment manual.
- [ ] Verify gas_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify bed_height_mm is within normal operating range as per equipment manual.
...
### 1. Grate bar deformation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating grate bar deformation.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory wear.
...
### 4. Pallet car wheel failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pallet car wheel failure.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-002) for stock levels,
