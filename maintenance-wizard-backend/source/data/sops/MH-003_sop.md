# Maintenance SOP: Gantry Crane (MH-003)

**Document No:** SOP-MH-003-01
**Category:** Material Handling Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-MH-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Gantry Crane (MH-003) to ensure reliable operation and to support
...
and breakdown maintenance of Gantry Crane units within the Material Handling Equipment.
...
- [ ] Verify rail_wheel_vibration_mm_s is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rail wheel wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-MH-003-01.
...
### 3. Drive gearbox failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive gearbox failure.
...
Refer to spare parts master record (part IDs prefixed SP-MH-003) for stock levels,
