# Maintenance SOP: Screening Unit (Pellet) (PLT-005)

**Document No:** SOP-PLT-005-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Screening Unit (Pellet) (PLT-005) to ensure reliable operation and to support
...
and breakdown maintenance of Screening Unit (Pellet) units within the Pellet Plant.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating screen mesh wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-005-01.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-005) for stock levels,
