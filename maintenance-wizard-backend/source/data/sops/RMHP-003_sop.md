# Maintenance SOP: Conveyor Belt System (RMHP-003)

**Document No:** SOP-RMHP-003-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Conveyor Belt System (RMHP-003) to ensure reliable operation and to support
...
and breakdown maintenance of Conveyor Belt System units within the Raw Material Handling Plant.
...
- [ ] Verify belt_tension_kN is within normal operating range as per equipment manual.
- [ ] Verify temperature_bearing_C is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-003-01.
...
### 2. Idler bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating idler bearing failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating belt tear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pulley misalignment.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-003) for stock levels,
