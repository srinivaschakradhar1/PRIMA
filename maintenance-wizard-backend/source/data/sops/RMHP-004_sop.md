# Maintenance SOP: Vibrating Feeder (RMHP-004)

**Document No:** SOP-RMHP-004-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Vibrating Feeder (RMHP-004) to ensure reliable operation and to support
...
and breakdown maintenance of Vibrating Feeder units within the Raw Material Handling Plant.
...
### 1. Spring fatigue failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating spring fatigue failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-004-01.
...
### 3. Out-of-balance vibration

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating out-of-balance vibration.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating motor winding fault.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-004) for stock levels,
