# Maintenance SOP: Secondary Dedusting System (BOF-007)

**Document No:** SOP-BOF-007-01
**Category:** Basic Oxygen Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BOF-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Secondary Dedusting System (BOF-007) to ensure reliable operation and to support
...
and breakdown maintenance of Secondary Dedusting System units within the Basic Oxygen Furnace.
...
### 1. Filter bag clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating filter bag clogging.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BOF-007-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan imbalance.
...
### 3. Pulse valve failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pulse valve failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating ductwork leakage.
...
Refer to spare parts master record (part IDs prefixed SP-BOF-007) for stock levels,
