# Maintenance SOP: Cooling System (BF) (BF-009)

**Document No:** SOP-BF-009-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling System (BF) (BF-009) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling System (BF) units within the Blast Furnace.
...
- [ ] Verify water_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify return_water_temp_C is within normal operating range as per equipment manual.
- [ ] Verify pump_vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify heat_load_MW is within normal operating range as per equipment manual.
...
### 1. Cooling pipe scaling

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cooling pipe scaling.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-009-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pump seal leakage.
...
### 3. Stave cooling element leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating stave cooling element leak.
...
Refer to spare parts master record (part IDs prefixed SP-BF-009) for stock levels,
