# Maintenance SOP: Shear (Plate Mill) (RM-008)

**Document No:** SOP-RM-008-01
**Category:** Rolling Mills - Plate Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Shear (Plate Mill) (RM-008) to ensure reliable operation and to support
...
and breakdown maintenance of Shear (Plate Mill) units within the Rolling Mills - Plate Mill.
...
- [ ] Verify shear_force_kN is within normal operating range as per equipment manual.
- [ ] Verify blade_gap_mm is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify blade_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify cycle_time_s is within normal operating range as per equipment manual.
...
### 1. Blade wear/chipping

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating blade wear/chipping.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-008-01.
...
### 3. Drive coupling wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive coupling wear.
...
### 4. Blade clearance misalignment

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating blade clearance misalignment.
...
Refer to spare parts master record (part IDs prefixed SP-RM-008) for stock levels,
