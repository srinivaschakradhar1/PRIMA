# Maintenance SOP: Electrostatic Precipitator (ENV) (ENV-002)

**Document No:** SOP-ENV-002-01
**Category:** Environmental Control Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-ENV-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Electrostatic Precipitator (ENV) (ENV-002) to ensure reliable operation and to support
...
and breakdown maintenance of Electrostatic Precipitator (ENV) units within the Environmental Control Systems.
...
- [ ] Verify collection_efficiency_pct is within normal operating range as per equipment manual.
- [ ] Verify emission_concentration_mgm3 is within normal operating range as per equipment manual.
- [ ] Verify rapping_frequency_Hz is within normal operating range as per equipment manual.
- [ ] Verify field_voltage_kV is within normal operating range as per equipment manual.
- [ ] Verify gas_temperature_C is within normal operating range as per equipment manual.
...
### 1. Electrode wire breakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating electrode wire breakage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-ENV-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating insulator contamination.
...
### 3. Rapping mechanism failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rapping mechanism failure.
...
### 4. Transformer/rectifier fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating transformer/rectifier fault.
...
Refer to spare parts master record (part IDs prefixed SP-ENV-002) for stock levels,
