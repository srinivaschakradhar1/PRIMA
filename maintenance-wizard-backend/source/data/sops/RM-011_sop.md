# Maintenance SOP: Cooling Bed (RM-011)

**Document No:** SOP-RM-011-01
**Category:** Rolling Mills - Bar & Rod Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-011-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling Bed (RM-011) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling Bed units within the Rolling Mills - Bar & Rod Mill.
...
- [ ] Verify rake_speed_m_min is within normal operating range as per equipment manual.
- [ ] Verify bar_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify drive_motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify tooth_wear_mm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rake tooth wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-011-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating frame misalignment.
...
Refer to spare parts master record (part IDs prefixed SP-RM-011) for stock levels,
