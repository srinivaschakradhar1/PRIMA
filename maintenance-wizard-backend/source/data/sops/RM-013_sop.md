# Maintenance SOP: Wire Rod Block (RM-013)

**Document No:** SOP-RM-013-01
**Category:** Rolling Mills - Wire Rod Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-013-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Wire Rod Block (RM-013) to ensure reliable operation and to support
...
and breakdown maintenance of Wire Rod Block units within the Rolling Mills - Wire Rod Mill.
...
- [ ] Verify block_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify rod_temperature_C is within normal operating range as per equipment manual.
...
- [ ] Verify lubrication_pressure_bar is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll ring wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-013-01.
...
### 2. High-speed bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating high-speed bearing failure.
...
### 3. Lubrication system fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating lubrication system fault.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gearbox overheating.
...
Refer to spare parts master record (part IDs prefixed SP-RM-013) for stock levels,
