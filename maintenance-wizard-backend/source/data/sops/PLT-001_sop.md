# Maintenance SOP: Balling Disc (PLT-001)

**Document No:** SOP-PLT-001-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Balling Disc (PLT-001) to ensure reliable operation and to support
...
and breakdown maintenance of Balling Disc units within the Pellet Plant.
...
- [ ] Verify disc_speed_rpm is within normal operating range as per equipment manual.
...
- [ ] Verify pellet_size_mm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-001-01.
...
### 2. Tilt actuator fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tilt actuator fault.
...
### 3. Scraper blade wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating scraper blade wear.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-001) for stock levels,
