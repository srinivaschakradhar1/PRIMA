# Maintenance SOP: Pulverized Coal Injection (PCI) System (BF-004)

**Document No:** SOP-BF-004-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Pulverized Coal Injection (PCI) System (BF-004) to ensure reliable operation and to support
...
and breakdown maintenance of Pulverized Coal Injection (PCI) System units within the Blast Furnace.
...
- [ ] Verify coal_flow_rate_t_h is within normal operating range as per equipment manual.
- [ ] Verify injection_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify mill_vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify nitrogen_flow_m3_h is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating lance blockage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-004-01.
...
### 2. Mill grinding element wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mill grinding element wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pipe wear/erosion.
...
Refer to spare parts master record (part IDs prefixed SP-BF-004) for stock levels,
