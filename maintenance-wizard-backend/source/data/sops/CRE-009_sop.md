# Maintenance SOP: Cooling Tower Fan (Critical) (CRE-009)

**Document No:** SOP-CRE-009-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling Tower Fan (Critical) (CRE-009) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling Tower Fan (Critical) units within the Critical Rotating Equipment.
...
- [ ] Verify blade_pitch_deg is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating blade damage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-009-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive shaft misalignment.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-009) for stock levels,
