# Maintenance SOP: Electrostatic Precipitator (Sinter) (SNT-006)

**Document No:** SOP-SNT-006-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Electrostatic Precipitator (Sinter) (SNT-006) to ensure reliable operation and to support
...
and breakdown maintenance of Electrostatic Precipitator (Sinter) units within the Sinter Plant.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-006-01.
...
### 4. Hopper ash blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hopper ash blockage.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-006) for stock levels,
