# Maintenance SOP: Wagon Tippler (RMHP-001)

**Document No:** SOP-RMHP-001-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Wagon Tippler (RMHP-001) to ensure reliable operation and to support
...
and breakdown maintenance of Wagon Tippler units within the Raw Material Handling Plant.
...
- [ ] Verify tipping_angle_deg is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-001-01.
...
### 2. Tipping mechanism jam

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tipping mechanism jam.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic pump failure.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-001) for stock levels,
