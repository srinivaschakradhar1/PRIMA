# Maintenance SOP: Strand Cooling System (CCM-004)

**Document No:** SOP-CCM-004-01
**Category:** Continuous Casting Machine
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CCM-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Strand Cooling System (CCM-004) to ensure reliable operation and to support
...
and breakdown maintenance of Strand Cooling System units within the Continuous Casting Machine.
...
- [ ] Verify spray_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify nozzle_blockage_pct is within normal operating range as per equipment manual.
- [ ] Verify strand_surface_temp_C is within normal operating range as per equipment manual.
- [ ] Verify header_pressure_bar is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating nozzle clogging.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CCM-004-01.
...
### 2. Spray header corrosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating spray header corrosion.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pump degradation.
...
Refer to spare parts master record (part IDs prefixed SP-CCM-004) for stock levels,
