# Maintenance SOP: Cooler (Pellet) (PLT-004)

**Document No:** SOP-PLT-004-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooler (Pellet) (PLT-004) to ensure reliable operation and to support
...
and breakdown maintenance of Cooler (Pellet) units within the Pellet Plant.
...
- [ ] Verify cooler_air_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify outlet_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify fan_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify bed_depth_mm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan bearing wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating grate plate cracking.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating air leakage.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-004) for stock levels,
