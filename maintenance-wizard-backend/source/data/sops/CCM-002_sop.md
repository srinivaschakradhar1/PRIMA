# Maintenance SOP: Tundish (CCM-002)

**Document No:** SOP-CCM-002-01
**Category:** Continuous Casting Machine
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CCM-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Tundish (CCM-002) to ensure reliable operation and to support
...
and breakdown maintenance of Tundish units within the Continuous Casting Machine.
...
- [ ] Verify steel_level_mm is within normal operating range as per equipment manual.
- [ ] Verify temperature_C is within normal operating range as per equipment manual.
- [ ] Verify slide_gate_position_pct is within normal operating range as per equipment manual.
- [ ] Verify refractory_wear_mm is within normal operating range as per equipment manual.
- [ ] Verify argon_flow_Nm3_h is within normal operating range as per equipment manual.
...
### 1. Refractory erosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory erosion.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CCM-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating slide gate wear.
...
### 4. Level sensor fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating level sensor fault.
...
Refer to spare parts master record (part IDs prefixed SP-CCM-002) for stock levels,
