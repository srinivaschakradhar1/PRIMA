# Maintenance SOP: Gas Collecting Main (COP-007)

**Document No:** SOP-COP-007-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Gas Collecting Main (COP-007) to ensure reliable operation and to support
...
and breakdown maintenance of Gas Collecting Main units within the Coke Oven Plant.
...
- [ ] Verify gas_pressure_mbar is within normal operating range as per equipment manual.
- [ ] Verify gas_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify H2S_concentration_ppm is within normal operating range as per equipment manual.
- [ ] Verify ammonia_concentration_ppm is within normal operating range as per equipment manual.
...
### 1. Pipe corrosion leak

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pipe corrosion leak.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-007-01.
...
### 2. Tar deposit blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tar deposit blockage.
...
### 3. Pressure regulator fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pressure regulator fault.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating expansion joint failure.
...
Refer to spare parts master record (part IDs prefixed SP-COP-007) for stock levels,
