# Maintenance SOP: Forklift (MH-006)

**Document No:** SOP-MH-006-01
**Category:** Material Handling Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-MH-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Forklift (MH-006) to ensure reliable operation and to support
...
and breakdown maintenance of Forklift units within the Material Handling Equipment.
...
- [ ] Verify engine_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify fuel_level_pct is within normal operating range as per equipment manual.
- [ ] Verify tire_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify operating_hours is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic pump wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-MH-006-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating engine overheating.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mast chain wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating brake fluid leak.
...
Refer to spare parts master record (part IDs prefixed SP-MH-006) for stock levels,
