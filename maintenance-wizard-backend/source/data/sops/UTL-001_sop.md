# Maintenance SOP: Boiler (UTL-001)

**Document No:** SOP-UTL-001-01
**Category:** Utility - Power Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Boiler (UTL-001) to ensure reliable operation and to support
...
and breakdown maintenance of Boiler units within the Utility - Power Plant.
...
- [ ] Verify steam_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify steam_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify feedwater_flow_t_h is within normal operating range as per equipment manual.
- [ ] Verify flue_gas_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify drum_level_pct is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tube leakage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-001-01.
...
### 3. Feedwater pump failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating feedwater pump failure.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-001) for stock levels,
