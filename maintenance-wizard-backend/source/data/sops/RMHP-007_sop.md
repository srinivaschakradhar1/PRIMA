# Maintenance SOP: Hopper & Bunker (RMHP-007)

**Document No:** SOP-RMHP-007-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Hopper & Bunker (RMHP-007) to ensure reliable operation and to support
...
and breakdown maintenance of Hopper & Bunker units within the Raw Material Handling Plant.
...
- [ ] Verify level_pct is within normal operating range as per equipment manual.
- [ ] Verify wall_temp_C is within normal operating range as per equipment manual.
- [ ] Verify strain_gauge_microstrain is within normal operating range as per equipment manual.
- [ ] Verify discharge_gate_position_pct is within normal operating range as per equipment manual.
- [ ] Verify dust_level_mgm3 is within normal operating range as per equipment manual.
...
### 1. Material bridging/blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating material bridging/blockage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-007-01.
...
### 2. Gate actuator failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gate actuator failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating liner wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating structural crack.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-007) for stock levels,
