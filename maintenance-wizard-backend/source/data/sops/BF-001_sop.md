# Maintenance SOP: Blast Furnace Shell (BF-001)

**Document No:** SOP-BF-001-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Blast Furnace Shell (BF-001) to ensure reliable operation and to support
...
and breakdown maintenance of Blast Furnace Shell units within the Blast Furnace.
...
- [ ] Verify shell_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify internal_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify cooling_water_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify stave_temperature_C is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-001-01.
...
### 2. Cooling stave cracking

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cooling stave cracking.
...
### 3. Shell plate corrosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating shell plate corrosion.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tuyere damage.
...
Refer to spare parts master record (part IDs prefixed SP-BF-001) for stock levels,
