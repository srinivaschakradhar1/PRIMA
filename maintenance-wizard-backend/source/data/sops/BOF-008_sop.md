# Maintenance SOP: Slag Handling System (BOF) (BOF-008)

**Document No:** SOP-BOF-008-01
**Category:** Basic Oxygen Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BOF-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Slag Handling System (BOF) (BOF-008) to ensure reliable operation and to support
...
and breakdown maintenance of Slag Handling System (BOF) units within the Basic Oxygen Furnace.
...
- [ ] Verify conveyor_speed_m_s is within normal operating range as per equipment manual.
- [ ] Verify slag_pot_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify crane_load_t is within normal operating range as per equipment manual.
...
### 1. Slag pot lining wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating slag pot lining wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BOF-008-01.
...
### 2. Conveyor belt damage from hot slag

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating conveyor belt damage from hot slag.
...
### 3. Crane wire rope wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating crane wire rope wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic leak.
...
Refer to spare parts master record (part IDs prefixed SP-BOF-008) for stock levels,
