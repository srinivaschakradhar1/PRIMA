# Maintenance SOP: Pump (Water Systems) (UTL-010)

**Document No:** SOP-UTL-010-01
**Category:** Utility - Water Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-010-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Pump (Water Systems) (UTL-010) to ensure reliable operation and to support
...
and breakdown maintenance of Pump (Water Systems) units within the Utility - Water Systems.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-010-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating impeller wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cavitation damage.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-010) for stock levels,
