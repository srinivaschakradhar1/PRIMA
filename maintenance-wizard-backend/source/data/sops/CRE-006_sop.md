# Maintenance SOP: Gearbox (Critical) (CRE-006)

**Document No:** SOP-CRE-006-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Gearbox (Critical) (CRE-006) to ensure reliable operation and to support
...
and breakdown maintenance of Gearbox (Critical) units within the Critical Rotating Equipment.
...
- [ ] Verify oil_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify output_torque_Nm is within normal operating range as per equipment manual.
- [ ] Verify oil_particle_count is within normal operating range as per equipment manual.
...
### 1. Gear tooth wear/pitting

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gear tooth wear/pitting.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-006-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating oil seal leakage.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-006) for stock levels,
