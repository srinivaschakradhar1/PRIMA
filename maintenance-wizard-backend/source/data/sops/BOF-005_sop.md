# Maintenance SOP: Scrap Charging Crane (BOF-005)

**Document No:** SOP-BOF-005-01
**Category:** Basic Oxygen Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BOF-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Scrap Charging Crane (BOF-005) to ensure reliable operation and to support
...
and breakdown maintenance of Scrap Charging Crane units within the Basic Oxygen Furnace.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating wire rope wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BOF-005-01.
...
### 4. Trolley wheel wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating trolley wheel wear.
...
Refer to spare parts master record (part IDs prefixed SP-BOF-005) for stock levels,
