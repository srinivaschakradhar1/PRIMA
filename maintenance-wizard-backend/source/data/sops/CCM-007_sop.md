# Maintenance SOP: Roller Table (CCM-007)

**Document No:** SOP-CCM-007-01
**Category:** Continuous Casting Machine
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CCM-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Roller Table (CCM-007) to ensure reliable operation and to support
...
and breakdown maintenance of Roller Table units within the Continuous Casting Machine.
...
- [ ] Verify roll_wear_mm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CCM-007-01.
...
### 2. Roll surface pitting

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll surface pitting.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive chain wear.
...
Refer to spare parts master record (part IDs prefixed SP-CCM-007) for stock levels,
