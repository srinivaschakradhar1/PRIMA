# Maintenance SOP: Grinding Mill (Pellet) (PLT-006)

**Document No:** SOP-PLT-006-01
**Category:** Pellet Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-PLT-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Grinding Mill (Pellet) (PLT-006) to ensure reliable operation and to support
...
and breakdown maintenance of Grinding Mill (Pellet) units within the Pellet Plant.
...
- [ ] Verify mill_speed_rpm is within normal operating range as per equipment manual.
...
- [ ] Verify particle_size_micron is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-PLT-006-01.
...
### 2. Trunnion bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating trunnion bearing failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gearbox wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mill imbalance.
...
Refer to spare parts master record (part IDs prefixed SP-PLT-006) for stock levels,
