# Maintenance SOP: Electrode Lifting System (EAF-002)

**Document No:** SOP-EAF-002-01
**Category:** Electric Arc Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-EAF-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Electrode Lifting System (EAF-002) to ensure reliable operation and to support
...
and breakdown maintenance of Electrode Lifting System units within the Electric Arc Furnace.
...
- [ ] Verify electrode_position_mm is within normal operating range as per equipment manual.
- [ ] Verify hydraulic_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify lift_motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify electrode_consumption_kg_t is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-EAF-002-01.
...
### 2. Electrode clamp wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating electrode clamp wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating position sensor fault.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating mast guide wear.
...
Refer to spare parts master record (part IDs prefixed SP-EAF-002) for stock levels,
