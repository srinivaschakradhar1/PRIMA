# Maintenance SOP: Reheating Furnace (RM-001)

**Document No:** SOP-RM-001-01
**Category:** Rolling Mills - Hot Strip Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Reheating Furnace (RM-001) to ensure reliable operation and to support
...
and breakdown maintenance of Reheating Furnace units within the Rolling Mills - Hot Strip Mill.
...
- [ ] Verify furnace_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify fuel_flow_rate_m3_h is within normal operating range as per equipment manual.
- [ ] Verify slab_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify O2_concentration_pct is within normal operating range as per equipment manual.
- [ ] Verify walking_beam_speed_m_min is within normal operating range as per equipment manual.
...
### 1. Refractory degradation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory degradation.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-001-01.
...
### 2. Burner malfunction

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating burner malfunction.
...
### 3. Walking beam mechanism wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating walking beam mechanism wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating skid pipe damage.
...
Refer to spare parts master record (part IDs prefixed SP-RM-001) for stock levels,
