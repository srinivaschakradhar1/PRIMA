# Maintenance SOP: Conveyor (Sinter Plant) (SNT-008)

**Document No:** SOP-SNT-008-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Conveyor (Sinter Plant) (SNT-008) to ensure reliable operation and to support
...
and breakdown maintenance of Conveyor (Sinter Plant) units within the Sinter Plant.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-008-01.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-008) for stock levels,
