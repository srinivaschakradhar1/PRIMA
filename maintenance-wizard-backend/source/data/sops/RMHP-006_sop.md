# Maintenance SOP: Screen (RMHP) (RMHP-006)

**Document No:** SOP-RMHP-006-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Screen (RMHP) (RMHP-006) to ensure reliable operation and to support
...
and breakdown maintenance of Screen (RMHP) units within the Raw Material Handling Plant.
...
- [ ] Verify screen_deck_temp_C is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating screen mesh tear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-006-01.
...
### 2. Vibrator motor bearing wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating vibrator motor bearing wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating spring failure.
...
### 4. Structural fatigue crack

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating structural fatigue crack.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-006) for stock levels,
