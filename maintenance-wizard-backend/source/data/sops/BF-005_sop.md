# Maintenance SOP: Cast House Equipment (BF-005)

**Document No:** SOP-BF-005-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cast House Equipment (BF-005) to ensure reliable operation and to support
...
and breakdown maintenance of Cast House Equipment units within the Blast Furnace.
...
- [ ] Verify runner_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify skimmer_position_mm is within normal operating range as per equipment manual.
...
- [ ] Verify torpedo_ladle_temp_C is within normal operating range as per equipment manual.
...
### 1. Runner refractory wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating runner refractory wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-005-01.
...
### 2. Skimmer actuator failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating skimmer actuator failure.
...
### 3. Trough lining erosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating trough lining erosion.
...
Refer to spare parts master record (part IDs prefixed SP-BF-005) for stock levels,
