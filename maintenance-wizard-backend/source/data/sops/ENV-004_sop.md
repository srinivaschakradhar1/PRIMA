# Maintenance SOP: Dust Suppression System (ENV-004)

**Document No:** SOP-ENV-004-01
**Category:** Environmental Control Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-ENV-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Dust Suppression System (ENV-004) to ensure reliable operation and to support
...
and breakdown maintenance of Dust Suppression System units within the Environmental Control Systems.
...
- [ ] Verify tank_level_pct is within normal operating range as per equipment manual.
- [ ] Verify pump_vibration_mm_s is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-ENV-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pump failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating solenoid valve fault.
...
Refer to spare parts master record (part IDs prefixed SP-ENV-004) for stock levels,
