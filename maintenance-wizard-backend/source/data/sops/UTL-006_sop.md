# Maintenance SOP: Nitrogen Plant (ASU) (UTL-006)

**Document No:** SOP-UTL-006-01
**Category:** Utility - Air Separation Unit
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Nitrogen Plant (ASU) (UTL-006) to ensure reliable operation and to support
...
and breakdown maintenance of Nitrogen Plant (ASU) units within the Utility - Air Separation Unit.
...
- [ ] Verify column_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify N2_purity_pct is within normal operating range as per equipment manual.
- [ ] Verify cold_box_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify compressor_load_pct is within normal operating range as per equipment manual.
- [ ] Verify flow_rate_Nm3_h is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating heat exchanger fouling.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-006-01.
...
### 2. Compressor valve wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating compressor valve wear.
...
### 3. Purity analyzer drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating purity analyzer drift.
...
### 4. Expansion turbine wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating expansion turbine wear.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-006) for stock levels,
