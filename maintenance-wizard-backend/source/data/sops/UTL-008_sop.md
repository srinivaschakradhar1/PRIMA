# Maintenance SOP: Clarifier (UTL-008)

**Document No:** SOP-UTL-008-01
**Category:** Utility - Water Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Clarifier (UTL-008) to ensure reliable operation and to support
...
and breakdown maintenance of Clarifier units within the Utility - Water Systems.
...
- [ ] Verify rake_drive_torque_Nm is within normal operating range as per equipment manual.
...
### 1. Rake drive gearbox failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rake drive gearbox failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-008-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating scraper arm wear.
...
### 3. Sludge pump blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating sludge pump blockage.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating sensor fouling.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-008) for stock levels,
