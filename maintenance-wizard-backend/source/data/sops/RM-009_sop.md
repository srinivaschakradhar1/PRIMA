# Maintenance SOP: Rolling Stand (Bar & Rod Mill) (RM-009)

**Document No:** SOP-RM-009-01
**Category:** Rolling Mills - Bar & Rod Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Rolling Stand (Bar & Rod Mill) (RM-009) to ensure reliable operation and to support
...
and breakdown maintenance of Rolling Stand (Bar & Rod Mill) units within the Rolling Mills - Bar & Rod Mill.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating roll groove wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-009-01.
...
### 3. Guide misalignment

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating guide misalignment.
...
Refer to spare parts master record (part IDs prefixed SP-RM-009) for stock levels,
