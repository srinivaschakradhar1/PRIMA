# Maintenance SOP: Dust Collector (Sinter) (SNT-007)

**Document No:** SOP-SNT-007-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-007-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Dust Collector (Sinter) (SNT-007) to ensure reliable operation and to support
...
and breakdown maintenance of Dust Collector (Sinter) units within the Sinter Plant.
...
### 1. Filter bag tearing

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating filter bag tearing.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-007-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating dust cake buildup.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-007) for stock levels,
