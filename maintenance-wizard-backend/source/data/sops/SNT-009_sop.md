# Maintenance SOP: Fans and Blowers (Sinter) (SNT-009)

**Document No:** SOP-SNT-009-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Fans and Blowers (Sinter) (SNT-009) to ensure reliable operation and to support
...
and breakdown maintenance of Fans and Blowers (Sinter) units within the Sinter Plant.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-009-01.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-009) for stock levels,
