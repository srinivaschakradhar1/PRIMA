# Maintenance SOP: Roughing Mill (RM-002)

**Document No:** SOP-RM-002-01
**Category:** Rolling Mills - Hot Strip Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Roughing Mill (RM-002) to ensure reliable operation and to support
...
and breakdown maintenance of Roughing Mill units within the Rolling Mills - Hot Strip Mill.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-002-01.
...
### 3. Hydraulic gap control fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic gap control fault.
...
Refer to spare parts master record (part IDs prefixed SP-RM-002) for stock levels,
