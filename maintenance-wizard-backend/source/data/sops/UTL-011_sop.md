# Maintenance SOP: Filtration System (Water) (UTL-011)

**Document No:** SOP-UTL-011-01
**Category:** Utility - Water Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-011-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Filtration System (Water) (UTL-011) to ensure reliable operation and to support
...
and breakdown maintenance of Filtration System (Water) units within the Utility - Water Systems.
...
- [ ] Verify flow_rate_m3_h is within normal operating range as per equipment manual.
- [ ] Verify turbidity_NTU is within normal operating range as per equipment manual.
- [ ] Verify backwash_frequency_per_day is within normal operating range as per equipment manual.
- [ ] Verify filter_media_condition_pct is within normal operating range as per equipment manual.
...
### 1. Filter media clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating filter media clogging.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-011-01.
...
### 2. Backwash valve failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating backwash valve failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating underdrain damage.
...
### 4. Flow control valve fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating flow control valve fault.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-011) for stock levels,
