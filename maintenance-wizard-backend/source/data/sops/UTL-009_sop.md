# Maintenance SOP: Cooling Tower (Water Systems) (UTL-009)

**Document No:** SOP-UTL-009-01
**Category:** Utility - Water Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-009-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Cooling Tower (Water Systems) (UTL-009) to ensure reliable operation and to support
...
and breakdown maintenance of Cooling Tower (Water Systems) units within the Utility - Water Systems.
...
- [ ] Verify fan_speed_rpm is within normal operating range as per equipment manual.
- [ ] Verify water_outlet_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify water_flow_rate_m3_h is within normal operating range as per equipment manual.
- [ ] Verify fan_vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify fill_blockage_pct is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fan blade damage.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-009-01.
...
### 2. Fill media fouling

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating fill media fouling.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gearbox oil leak.
...
### 4. Basin water level fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating basin water level fault.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-009) for stock levels,
