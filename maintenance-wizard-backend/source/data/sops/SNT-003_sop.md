# Maintenance SOP: Ignition Furnace (SNT-003)

**Document No:** SOP-SNT-003-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Ignition Furnace (SNT-003) to ensure reliable operation and to support
...
and breakdown maintenance of Ignition Furnace units within the Sinter Plant.
...
- [ ] Verify burner_pressure_mbar is within normal operating range as per equipment manual.
- [ ] Verify refractory_temp_C is within normal operating range as per equipment manual.
...
### 1. Burner nozzle clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating burner nozzle clogging.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-003-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating igniter failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating gas valve fault.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-003) for stock levels,
