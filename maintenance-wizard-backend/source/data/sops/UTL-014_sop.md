# Maintenance SOP: Air Receiver (UTL-014)

**Document No:** SOP-UTL-014-01
**Category:** Utility - Compressed Air Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-014-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Air Receiver (UTL-014) to ensure reliable operation and to support
...
and breakdown maintenance of Air Receiver units within the Utility - Compressed Air Systems.
...
- [ ] Verify internal_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify temperature_C is within normal operating range as per equipment manual.
- [ ] Verify condensate_level_pct is within normal operating range as per equipment manual.
- [ ] Verify relief_valve_status is within normal operating range as per equipment manual.
- [ ] Verify wall_thickness_mm is within normal operating range as per equipment manual.
...
### 1. Condensate drain valve failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating condensate drain valve failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-014-01.
...
### 2. Relief valve fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating relief valve fault.
...
### 3. Corrosion/wall thinning

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating corrosion/wall thinning.
...
### 4. Pressure gauge drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pressure gauge drift.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-014) for stock levels,
