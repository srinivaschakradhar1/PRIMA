# Maintenance SOP: Crusher (Sinter) (SNT-004)

**Document No:** SOP-SNT-004-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Crusher (Sinter) (SNT-004) to ensure reliable operation and to support
...
and breakdown maintenance of Crusher (Sinter) units within the Sinter Plant.
...
- [ ] Verify hammer_wear_mm is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hammer wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating liner cracking.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-004) for stock levels,
