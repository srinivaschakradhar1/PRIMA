# Maintenance SOP: Temperature Measurement System (SM-006)

**Document No:** SOP-SM-006-01
**Category:** Secondary Metallurgy
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SM-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Temperature Measurement System (SM-006) to ensure reliable operation and to support
...
and breakdown maintenance of Temperature Measurement System units within the Secondary Metallurgy.
...
- [ ] Verify thermocouple_reading_C is within normal operating range as per equipment manual.
- [ ] Verify sensor_response_time_s is within normal operating range as per equipment manual.
- [ ] Verify calibration_drift_pct is within normal operating range as per equipment manual.
- [ ] Verify lance_wear_mm is within normal operating range as per equipment manual.
- [ ] Verify signal_noise_level is within normal operating range as per equipment manual.
...
### 1. Thermocouple drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating thermocouple drift.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SM-006-01.
...
### 2. Lance immersion wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating lance immersion wear.
...
### 3. Signal cable damage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating signal cable damage.
...
Refer to spare parts master record (part IDs prefixed SP-SM-006) for stock levels,
