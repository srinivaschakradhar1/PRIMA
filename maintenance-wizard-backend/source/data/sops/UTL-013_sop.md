# Maintenance SOP: Air Dryer (UTL-013)

**Document No:** SOP-UTL-013-01
**Category:** Utility - Compressed Air Systems
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-UTL-013-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Air Dryer (UTL-013) to ensure reliable operation and to support
...
and breakdown maintenance of Air Dryer units within the Utility - Compressed Air Systems.
...
- [ ] Verify dew_point_C is within normal operating range as per equipment manual.
- [ ] Verify inlet_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify desiccant_condition_pct is within normal operating range as per equipment manual.
- [ ] Verify switching_valve_status is within normal operating range as per equipment manual.
...
### 1. Desiccant degradation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating desiccant degradation.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-UTL-013-01.
...
### 2. Switching valve failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating switching valve failure.
...
### 3. Heater element fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating heater element fault.
...
### 4. Pressure sensor drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pressure sensor drift.
...
Refer to spare parts master record (part IDs prefixed SP-UTL-013) for stock levels,
