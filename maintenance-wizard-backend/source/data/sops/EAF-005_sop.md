# Maintenance SOP: Fume Extraction System (EAF) (EAF-005)

**Document No:** SOP-EAF-005-01
**Category:** Electric Arc Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-EAF-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Fume Extraction System (EAF) (EAF-005) to ensure reliable operation and to support
...
and breakdown maintenance of Fume Extraction System (EAF) units within the Electric Arc Furnace.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-EAF-005-01.
...
### 3. Canopy hood damage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating canopy hood damage.
...
Refer to spare parts master record (part IDs prefixed SP-EAF-005) for stock levels,
