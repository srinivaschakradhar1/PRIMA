# Maintenance SOP: Galvanizing Line (FL-002)

**Document No:** SOP-FL-002-01
**Category:** Finishing Lines
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-FL-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Galvanizing Line (FL-002) to ensure reliable operation and to support
...
and breakdown maintenance of Galvanizing Line units within the Finishing Lines.
...
- [ ] Verify zinc_pot_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify line_speed_m_min is within normal operating range as per equipment manual.
- [ ] Verify coating_weight_g_m2 is within normal operating range as per equipment manual.
- [ ] Verify pot_level_mm is within normal operating range as per equipment manual.
- [ ] Verify air_knife_pressure_bar is within normal operating range as per equipment manual.
...
### 1. Zinc pot pump failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating zinc pot pump failure.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-FL-002-01.
...
### 2. Sink roll bearing wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating sink roll bearing wear.
...
### 3. Air knife nozzle clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating air knife nozzle clogging.
...
### 4. Induction heater fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating induction heater fault.
...
Refer to spare parts master record (part IDs prefixed SP-FL-002) for stock levels,
