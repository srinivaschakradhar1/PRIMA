# Maintenance SOP: Sinter Machine (SNT-002)

**Document No:** SOP-SNT-002-01
**Category:** Sinter Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SNT-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Sinter Machine (SNT-002) to ensure reliable operation and to support
...
and breakdown maintenance of Sinter Machine units within the Sinter Plant.
...
- [ ] Verify pallet_speed_m_min is within normal operating range as per equipment manual.
- [ ] Verify bed_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify windbox_pressure_mbar is within normal operating range as per equipment manual.
- [ ] Verify grate_bar_temp_C is within normal operating range as per equipment manual.
...
### 1. Grate bar burning/warping

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating grate bar burning/warping.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SNT-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pallet chain wear.
...
### 3. Windbox seal leakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating windbox seal leakage.
...
### 4. Drive chain stretch

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive chain stretch.
...
Refer to spare parts master record (part IDs prefixed SP-SNT-002) for stock levels,
