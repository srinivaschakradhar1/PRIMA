# Maintenance SOP: Coke Screening Plant (COP-006)

**Document No:** SOP-COP-006-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-006-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Coke Screening Plant (COP-006) to ensure reliable operation and to support
...
and breakdown maintenance of Coke Screening Plant units within the Coke Oven Plant.
...
- [ ] Verify vibration_amplitude_mm is within normal operating range as per equipment manual.
- [ ] Verify motor_current_A is within normal operating range as per equipment manual.
- [ ] Verify screen_temp_C is within normal operating range as per equipment manual.
- [ ] Verify throughput_t_h is within normal operating range as per equipment manual.
- [ ] Verify frequency_Hz is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating screen panel wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-006-01.
...
### 2. Vibrator bearing failure

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating vibrator bearing failure.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating drive belt slip.
...
### 4. Frame fatigue crack

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating frame fatigue crack.
...
Refer to spare parts master record (part IDs prefixed SP-COP-006) for stock levels,
