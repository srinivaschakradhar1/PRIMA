# Maintenance SOP: Ladle Furnace (SM-001)

**Document No:** SOP-SM-001-01
**Category:** Secondary Metallurgy
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SM-001-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Ladle Furnace (SM-001) to ensure reliable operation and to support
...
and breakdown maintenance of Ladle Furnace units within the Secondary Metallurgy.
...
- [ ] Verify bath_temperature_C is within normal operating range as per equipment manual.
...
- [ ] Verify power_consumption_kWh is within normal operating range as per equipment manual.
...
### 1. Refractory lining erosion

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory lining erosion.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SM-001-01.
...
### 2. Electrode arm wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating electrode arm wear.
...
### 3. Argon purging line blockage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating argon purging line blockage.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating transformer overheating.
...
Refer to spare parts master record (part IDs prefixed SP-SM-001) for stock levels,
