# Maintenance SOP: Turbine (Critical) (CRE-008)

**Document No:** SOP-CRE-008-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-008-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Turbine (Critical) (CRE-008) to ensure reliable operation and to support
...
and breakdown maintenance of Turbine (Critical) units within the Critical Rotating Equipment.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-008-01.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-008) for stock levels,
