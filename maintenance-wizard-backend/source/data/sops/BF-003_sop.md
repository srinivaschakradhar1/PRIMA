# Maintenance SOP: Hot Blast Stove (BF-003)

**Document No:** SOP-BF-003-01
**Category:** Blast Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BF-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Hot Blast Stove (BF-003) to ensure reliable operation and to support
...
and breakdown maintenance of Hot Blast Stove units within the Blast Furnace.
...
- [ ] Verify dome_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify blast_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify combustion_air_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify checker_brick_temp_C is within normal operating range as per equipment manual.
...
### 1. Checker brick collapse

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating checker brick collapse.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BF-003-01.
...
### 2. Combustion chamber crack

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating combustion chamber crack.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating valve seal leakage.
...
### 4. Refractory spalling

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating refractory spalling.
...
Refer to spare parts master record (part IDs prefixed SP-BF-003) for stock levels,
