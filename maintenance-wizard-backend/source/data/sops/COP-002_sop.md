# Maintenance SOP: Coal Charging Car (COP-002)

**Document No:** SOP-COP-002-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Coal Charging Car (COP-002) to ensure reliable operation and to support
...
and breakdown maintenance of Coal Charging Car units within the Coke Oven Plant.
...
- [ ] Verify hopper_load_t is within normal operating range as per equipment manual.
...
- [ ] Verify positioning_error_mm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-002-01.
...
### 4. Positioning sensor fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating positioning sensor fault.
...
Refer to spare parts master record (part IDs prefixed SP-COP-002) for stock levels,
