# Maintenance SOP: Argon Stirring System (SM-004)

**Document No:** SOP-SM-004-01
**Category:** Secondary Metallurgy
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SM-004-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Argon Stirring System (SM-004) to ensure reliable operation and to support
...
and breakdown maintenance of Argon Stirring System units within the Secondary Metallurgy.
...
- [ ] Verify argon_flow_rate_Nm3_h is within normal operating range as per equipment manual.
- [ ] Verify line_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify plug_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify flow_control_valve_position_pct is within normal operating range as per equipment manual.
- [ ] Verify leak_rate_pct is within normal operating range as per equipment manual.
...
### 1. Porous plug clogging

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating porous plug clogging.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SM-004-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pipe leakage.
...
### 4. Pressure regulator drift

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pressure regulator drift.
...
Refer to spare parts master record (part IDs prefixed SP-SM-004) for stock levels,
