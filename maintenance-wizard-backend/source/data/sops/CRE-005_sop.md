# Maintenance SOP: Blower (Critical) (CRE-005)

**Document No:** SOP-CRE-005-01
**Category:** Critical Rotating Equipment
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-CRE-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Blower (Critical) (CRE-005) to ensure reliable operation and to support
...
and breakdown maintenance of Blower (Critical) units within the Critical Rotating Equipment.
...
- [ ] Verify discharge_pressure_mbar is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-CRE-005-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating coupling wear.
...
Refer to spare parts master record (part IDs prefixed SP-CRE-005) for stock levels,
