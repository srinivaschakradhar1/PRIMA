# Maintenance SOP: Coke Quenching Tower (COP-005)

**Document No:** SOP-COP-005-01
**Category:** Coke Oven Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-COP-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Coke Quenching Tower (COP-005) to ensure reliable operation and to support
...
and breakdown maintenance of Coke Quenching Tower units within the Coke Oven Plant.
...
- [ ] Verify water_flow_m3_h is within normal operating range as per equipment manual.
- [ ] Verify spray_pressure_bar is within normal operating range as per equipment manual.
- [ ] Verify steam_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify nozzle_blockage_pct is within normal operating range as per equipment manual.
- [ ] Verify tower_vibration_mm_s is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-COP-005-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating pump cavitation.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating structural corrosion.
...
### 4. Water distribution imbalance

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating water distribution imbalance.
...
Refer to spare parts master record (part IDs prefixed SP-COP-005) for stock levels,
