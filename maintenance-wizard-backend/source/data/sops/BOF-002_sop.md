# Maintenance SOP: Oxygen Lance System (BOF-002)

**Document No:** SOP-BOF-002-01
**Category:** Basic Oxygen Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-BOF-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Oxygen Lance System (BOF-002) to ensure reliable operation and to support
...
and breakdown maintenance of Oxygen Lance System units within the Basic Oxygen Furnace.
...
- [ ] Verify lance_position_m is within normal operating range as per equipment manual.
- [ ] Verify oxygen_flow_rate_Nm3_h is within normal operating range as per equipment manual.
- [ ] Verify lance_tip_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify hoist_motor_current_A is within normal operating range as per equipment manual.
...
### 1. Lance tip burn-back

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating lance tip burn-back.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-BOF-002-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hoist cable wear.
...
### 3. Cooling water leak in lance

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating cooling water leak in lance.
...
### 4. Position encoder fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating position encoder fault.
...
Refer to spare parts master record (part IDs prefixed SP-BOF-002) for stock levels,
