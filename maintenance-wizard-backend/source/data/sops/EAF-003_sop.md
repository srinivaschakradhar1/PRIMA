# Maintenance SOP: EAF Transformer (EAF-003)

**Document No:** SOP-EAF-003-01
**Category:** Electric Arc Furnace
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-EAF-003-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for EAF Transformer (EAF-003) to ensure reliable operation and to support
...
and breakdown maintenance of EAF Transformer units within the Electric Arc Furnace.
...
- [ ] Verify oil_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify load_current_A is within normal operating range as per equipment manual.
- [ ] Verify tap_changer_position is within normal operating range as per equipment manual.
- [ ] Verify insulation_resistance_Mohm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-EAF-003-01.
...
### 2. Tap changer contact wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating tap changer contact wear.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating oil contamination.
...
Refer to spare parts master record (part IDs prefixed SP-EAF-003) for stock levels,
