# Maintenance SOP: Crusher (RMHP) (RMHP-005)

**Document No:** SOP-RMHP-005-01
**Category:** Raw Material Handling Plant
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RMHP-005-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Crusher (RMHP) (RMHP-005) to ensure reliable operation and to support
...
and breakdown maintenance of Crusher (RMHP) units within the Raw Material Handling Plant.
...
- [ ] Verify motor_load_pct is within normal operating range as per equipment manual.
- [ ] Verify crusher_vibration_mm_s is within normal operating range as per equipment manual.
- [ ] Verify bearing_temp_C is within normal operating range as per equipment manual.
- [ ] Verify throughput_t_h is within normal operating range as per equipment manual.
- [ ] Verify jaw_gap_mm is within normal operating range as per equipment manual.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RMHP-005-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating bearing overheating.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating rotor imbalance.
...
### 4. Hydraulic adjustment fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating hydraulic adjustment fault.
...
Refer to spare parts master record (part IDs prefixed SP-RMHP-005) for stock levels,
