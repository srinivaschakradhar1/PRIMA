# Maintenance SOP: Bundling Machine (RM-012)

**Document No:** SOP-RM-012-01
**Category:** Rolling Mills - Bar & Rod Mill
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-RM-012-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Bundling Machine (RM-012) to ensure reliable operation and to support
...
and breakdown maintenance of Bundling Machine units within the Rolling Mills - Bar & Rod Mill.
...
- [ ] Verify binding_force_kN is within normal operating range as per equipment manual.
...
- [ ] Verify wire_feed_rate_m_min is within normal operating range as per equipment manual.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating binding head wear.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-RM-012-01.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating wire feed jam.
...
### 4. Conveyor drive fault

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating conveyor drive fault.
...
Refer to spare parts master record (part IDs prefixed SP-RM-012) for stock levels,
