# Maintenance SOP: Vacuum Degasser (VD/VOD) (SM-002)

**Document No:** SOP-SM-002-01
**Category:** Secondary Metallurgy
**Revision:** 1.0
**Applicable Equipment Manual:** MAN-SM-002-01

## 1. Purpose

This SOP defines the standard maintenance practices, inspection checklist, and corrective
procedures for Vacuum Degasser (VD/VOD) (SM-002) to ensure reliable operation and to support
...
and breakdown maintenance of Vacuum Degasser (VD/VOD) units within the Secondary Metallurgy.
...
- [ ] Verify vacuum_pressure_mbar is within normal operating range as per equipment manual.
- [ ] Verify steam_flow_t_h is within normal operating range as per equipment manual.
- [ ] Verify ladle_temperature_C is within normal operating range as per equipment manual.
- [ ] Verify oxygen_flow_Nm3_h is within normal operating range as per equipment manual.
- [ ] Verify ejector_vibration_mm_s is within normal operating range as per equipment manual.
...
### 1. Vacuum pump degradation

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating vacuum pump degradation.
...
4. Carry out corrective action (repair/replace as required) per equipment manual MAN-SM-002-01.
...
### 2. Steam ejector nozzle wear

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating steam ejector nozzle wear.
...
### 3. Vacuum seal leakage

**Trigger:** Condition monitoring alert, fault code, or operator observation indicating vacuum seal leakage.
...
**Trigger:** Condition monitoring alert, fault code, or operator observation indicating condenser fouling.
...
Refer to spare parts master record (part IDs prefixed SP-SM-002) for stock levels,
